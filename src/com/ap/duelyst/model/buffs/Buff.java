...
public abstract class Buff implements Cloneable {
    ...
    public Buff(int duration, boolean continuous, TargetType target, SideType side, RangeType range) {
        ...
        this.side = side;
        this.range = range;
        allyAttackTypes = Arrays.asList(AttackType.MELEE, AttackType.RANGED, AttackType.HYBRID);
        enemyAttackTypes = Arrays.asList(AttackType.MELEE, AttackType.RANGED, AttackType.HYBRID);
    }
