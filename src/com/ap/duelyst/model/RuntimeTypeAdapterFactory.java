...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    private final Map<String, Class<?>> labelToSubtype = new LinkedHashMap<String,
            Class<?>>();
    private final Map<Class<?>, String> subtypeToLabel = new LinkedHashMap<Class<?>,
            String>();
    ...
    public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
        ...
        return new TypeAdapter<R>() {
            ...
            public R read(JsonReader in) throws IOException {
                ...
                @SuppressWarnings("unchecked") // registration requires that subtype
                        // extends T
