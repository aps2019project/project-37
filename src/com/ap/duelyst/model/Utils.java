...
public class Utils {
    ...
    private static Shop unmodifiedShop;
    ...
    static {
        /*try {
            ...
            reader = new FileReader(
                    "src/com/ap/duelyst/data/shop.txt");
            c = reader.read();
            StringBuilder shopString = new StringBuilder();
            while (c != -1) {
                shopString.append((char) c);
                c = reader.read();
            }
            Utils.shop = getGson().fromJson(shopString.toString(),
                    new TypeToken<Shop>() {
                    }.getType());
            reader.close();
...
//        spells
        ...
        spell = new Spell("empower", 250, 1, "increases ap of ally minion by 2",
                buff);
        ...
        spell = new Spell("god-strength", 450, 2, "increases ap of ally hero by 4",
                buff);
        ...
        Buff buff1 = new WeaknessBuff(-1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE,
                EffectType.HEALTH, 2);
        buff = new CellBuff(2, false, TargetType.CELL, SideType.ALL,
                RangeType.SQUARE2,
                buff1);
        ...
        buff = new AttackBuff(1, false, TargetType.HERO, SideType.ENEMY,
                RangeType.ONE,
                8);
        spell = new Spell("lightning-bolt", 1250, 2, "damages enemy hero 4 points",
                buff);
        ...
        buff = new PoisonBuff(3, false, TargetType.HERO_MINION, SideType.ENEMY,
                RangeType.ONE);
        buff1 = new CellBuff(1, false, TargetType.CELL, SideType.ALL,
                RangeType.SQUARE3
                , buff);
        spell = new Spell("poison-lake", 900, 5, "adds poison effect in a square " +
                "size " +
                "3", buff1);
        ...
        buff1 = new PowerBuff(3, false, TargetType.MINION, SideType.ALLY,
                RangeType.ONE,
                EffectType.ATTACK_POWER, 4);
        spell = new Spell("madness", 650, 0, "increases ally minion ap but disarms " +
                "him"
                , buff, buff1);
        ...
        buff = new DispelBuff(1, false, TargetType.MINION, SideType.ALL,
                RangeType.ONE);
        spell = new Spell("dispel", 2100, 0, "dispels buffs for one enemy or ally",
                buff);
        ...
        buff = new WeaknessBuff(-1, false, TargetType.MINION, SideType.ALLY,
                RangeType.ONE,
                EffectType.HEALTH, 6);
        buff1 = new HolyBuff(3, false, TargetType.MINION, SideType.ALLY,
                RangeType.ONE,
                2);
        spell = new Spell("health-with-benefit", 2250, 0,
                "adds holly buff to a minion for 3 rounds and 2 points but weakens " +
                        "him " +
        ...
        buff = new WeaknessBuff(-1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE,
                EffectType.ATTACK_POWER, 4);
        spell = new Spell("weakening", 1000, 1, "weakens enemy minion's ap by 4 " +
                "points"
                , buff);
        ...
        spell = new Spell("sacrifice", 1600, 2,
                "weakens ally minion hp by 6 but increases it's ap by 8", buff,
                buff1);
        ...
        buff = new StunBuff(2, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE);
        spell = new Spell("shock", 1200, 1, "stuns an enemy minion for 2 rounds",
                buff);
...
//        minions
        Minion minion = new Minion("persian-archer", 300, 2, 6, 4,
                AttackType.RANGED, 7
                , null, null);
        ...
        minion = new Minion("persian-cavalry", 200, 4, 10, 6, AttackType.MELEE, 0,
                null
                , null);
        ...
        spell = new Spell("sp", 0, 0, "adds 5 more damage by every attack to a " +
                "certain " +
                "minion");
        ...
        minion = new Minion("transoxianain-archer", 500, 1, 3, 4, AttackType.RANGED
                , 5,
                null, null);
        ...
        minion = new Minion("transoxianain-sling-man", 600, 1, 4, 2,
                AttackType.RANGED,
                7, null, null);
        ...
        minion = new Minion("transoxianain-spear-man", 600, 1, 4, 4,
                AttackType.HYBRID,
                3, null, null);
        ...
        minion = new Minion("transoxianain-prince", 800, 6, 6, 10, AttackType.MELEE
                , 0,
                null, ActivationTime.COMBO);
        ...
        minion = new Minion("giant-rock-thrower", 300, 9, 12, 12, AttackType.RANGED
                , 7,
                null, null);
        ...
        buff = new PoisonBuff(3, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE);
        ...
        buff = new HolyBuff(Integer.MAX_VALUE, false, TargetType.MINION,
                SideType.ENEMY
                , RangeType.AROUND2, -1);
        ...
        buff = new HistoryBuff(false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE,
                4, 6);
        spell = new Spell("sp", 0, 0, "damages enemy minion after attack by 6 and 4" +
                " in " +
                "next rounds", buff);
        ...
        buff = new HistoryBuff(false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE,
                8);
        spell = new Spell("sp", 0, 0, "damages enemy minion after attack by 8 in " +
                "next " +
                "round", buff);
        ...
        buff = new HistoryBuff(false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE,
                6);
        spell = new Spell("sp", 0, 0, "damages enemy minion after attack by 6 in " +
                "next " +
                "round", buff);
        ...
        spell = new Spell("sp", 0, 0,
                "adds to himself and in 8 radius minion allys 2 ap and 1 hp " +
                        "weakness " +
        ...
        spell = new Spell("sp", 0, 0, "increases all ally minions ap by 1 point",
                buff);
        ...
        minion = new Minion("big-giant", 600, 9, 30, 8, AttackType.HYBRID, 2, null,
                null);
        ...
        buff = new StunBuff(1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.AROUND8);
        spell = new Spell("sp", 0, 0, "in 8 cell radius enemy minions will be " +
                "stunned " +
                "for 1 round", buff);
        ...
        buff = new HolyBuff(-1, true, TargetType.MINION, SideType.ALLY,
                RangeType.SELF,
                12);
...
//        heroes
        ...
        spell.setEffectFileName("fx_f2_eightgates_teallotus");
        Hero hero = new Hero("white-beast", 8000, 50, 4, AttackType.MELEE, 0, spell
                , 1,
                2);
        ...
        spell.setEffectFileName("fx_shadowcreep");
        hero = new Hero("seven-headed-dragon", 8000, 50, 4, AttackType.MELEE, 0,
                spell,
                0, 1);
        ...
        buff = new DispelBuff(1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE);
        ...
        buff = new HolyBuff(-1, true, TargetType.HERO, SideType.ALLY,
                RangeType.SELF, 3);
        spell = new Spell("sp", 0, 0, "adds a number 3 holy buff to himself " +
                "continues",
                buff);
        spell.setEffectFileName("fx_f1_warsurge");
...
//        items
        ...
        buff = new HolyBuff(-1, false, TargetType.HERO, SideType.ALLY,
                RangeType.ONE, 12);
        ...
        item = new UsableItem("damol-bow", 30000, "disarms enemy minion on hero " +
                "range " +
                "or hybrid attack",
        ...
        buff = new HolyBuff(2, false, TargetType.MINION, SideType.ALLY, RangeType.ONE,
                10);
        item = new CollectableItem("invincible-potion", "adds 10 holy buff to " +
                "minion " +
                "for 2 rounds",
                ActivationTime.PASSIVE, buff);
        ...
        buff.setCancelable(false);
        buff.setRandom(true);
        item = new CollectableItem("death-curse", "minion will get an attack buff 8" +
                " on " +
                "death",
        ...
        buff = new WeaknessBuff(1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE, EffectType.ATTACK_POWER, 2);
        buff.setRandom(true);
        item = new UsableItem("terror-hood", 5000, "weakens enemy ap by 2 for 1 " +
                "round " +
                "on attack",
                ActivationTime.ON_ATTACK, buff);
        ...
        item = new UsableItem("king-wisdom", 9000, "increases mana 1 point every " +
                "round",
                ActivationTime.PASSIVE, buff);
        ...
        buff = new PoisonBuff(1, false, TargetType.MINION, SideType.ENEMY,
                RangeType.ONE);
        buff.setRandom(true);
        buff.setAllyType(TargetType.ALL_MINIONS);
        ...
        buff.setCancelable(false);
        buff.setAllyType(TargetType.HERO);
        item = new UsableItem("shock-hammer", 15000, "hero disarms enemy minion for" +
                " 1 " +
                "round on attack",
                ActivationTime.ON_ATTACK, buff);
        ...
        buff.setAllyType(TargetType.ALL_MINIONS);
        buff.setRandom(true);
        item = new UsableItem("soul-eater", 25000, "all minions boost 1 random " +
                "minion " +
                "ap on death",
                ActivationTime.ON_DEATH, buff);
        ...
        buff = new HolyBuff(2, false, TargetType.MINION, SideType.ALLY,
                RangeType.SELF,
                1);
        buff.setAllyType(TargetType.ALL_MINIONS);
        item = new UsableItem("baptise", 20000, "every minion will get a holy buff " +
                "for " +
                "2 rounds on spawn",
                ActivationTime.ON_SPAWN, buff);
        ...
        item = new CollectableItem("chinese-swordsman", "boosts ally minions with " +
                "melee" +
                " attack by 5",
                ActivationTime.PASSIVE, buff);
        ...
        unmodifiedShop = new Shop(cards, items);
        if (shop == null || shop.getCards() == null || shop.getCards().isEmpty()) {
    ...
    public static Shop getUnmodifiedShop() {
        return unmodifiedShop;
    }
}
